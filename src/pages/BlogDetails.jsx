          ...
          <Row>
              ...
              <div className="comment__list mt-5">
                ...
                <div className="single__comment d-flex gap-3">
                  ...
                  <div className="comment__content">
                    <h6 className=" fw-bold">Ali Şansalan</h6>
                    <p className="section__description mb-0">14 Temmuz, 2022</p>
                ...
                <div className="leave__comment-form mt-5">
                  <h4>Yorum Yazın..</h4>
                  <p className="section__description">
                  Bir gönderi yapmak veya yorum yapmak için oturum açmalısınız
                  </p>
            ...
            <Col lg="4" md="4">
              <div className="recent__post mb-4">
                <h5 className=" fw-bold">En Son Yazılanlar</h5>
              </div>
              {blogData.map((item) => (
